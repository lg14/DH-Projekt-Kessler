...
UNWIND [item in pChildren WHERE NOT (apoc.meta.cypher.type(item) = "STRING") AND item._type = "quote"] AS quotes
UNWIND [item in quotes._children WHERE NOT (apoc.meta.cypher.type(item) = "STRING") AND item._type = "note"] AS quoteNotes
UNWIND [item in quoteNotes._children WHERE NOT (apoc.meta.cypher.type(item) = "STRING") AND item._type = "persName" AND item.key IS NOT NULL] AS persInText
